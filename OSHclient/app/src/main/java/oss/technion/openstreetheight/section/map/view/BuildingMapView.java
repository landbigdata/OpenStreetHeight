...
public interface BuildingMapView {
    ...
    void setMyLocationMarkerEnabled(boolean enabled);
    ...
    void vibrateLongPress();

    void checkLocationPermissionSilent();

    void checkLocationSettingsSilent();
}
